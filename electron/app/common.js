...
/* harmony import */ var _models_BIP39Signer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/BIP39Signer */ "./src/app/models/BIP39Signer.ts");
...
var MnemonicValidator = /** @class */ (function () {
    ...
    MnemonicValidator.checkMnemonic = function (mnemonic, wordlist) {
        var words = _models_BIP39Signer__WEBPACK_IMPORTED_MODULE_1__["BIP39Signer"].prepareMnemonic(mnemonic).split(' ');
        if (words.length % 3 !== 0) {
    ...
    MnemonicValidator.isValid = function (control) {
        if (control.value && _models_BIP39Signer__WEBPACK_IMPORTED_MODULE_1__["BIP39Signer"].validateMnemonic(control.value)) {
            return null;
        }
        return {
            'not a mnemonic': true
